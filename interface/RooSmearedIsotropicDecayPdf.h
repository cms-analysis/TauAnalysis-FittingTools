#ifndef TauAnalysis_FittingTools_RooSmearedIsotropicDecayPdf_h
#define TauAnalysis_FittingTools_RooSmearedIsotropicDecayPdf_h
...
#endif /* end of include guard: TauAnalysis_FittingTools_RooSmearedIsotropicDecayPdf_h */

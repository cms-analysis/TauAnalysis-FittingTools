#ifndef TauAnalysis_FittingTools_RooAbsEstimatablePdf_h
#define TauAnalysis_FittingTools_RooAbsEstimatablePdf_h
...
#endif /* end of include guard: TauAnalysis_FittingTools_RooAbsEstimatablePdf_h */

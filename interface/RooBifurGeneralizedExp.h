#ifndef TauAnalysis_FittingTools_RooBifurGeneralizedExp_h
#define TauAnalysis_FittingTools_RooBifurGeneralizedExp_h
...
#endif /* end of include guard: TauAnalysis_FittingTools_RooBifurGeneralizedExp_h */

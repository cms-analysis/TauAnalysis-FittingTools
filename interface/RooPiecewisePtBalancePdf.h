#ifndef TauAnalysis_FittingTools_RooPiecewisePtBalancePdf_h
#define TauAnalysis_FittingTools_RooPiecewisePtBalancePdf_h
...
#endif /* end of include guard: TauAnalysis_FittingTools_RooPiecewisePtBalancePdf_h */
